...
public class QuizQuestion10Content extends AppCompatActivity {
    private static final String TAG = "QuizQuestion10Content";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_quiz_question_10);
        ...
        radioGroupTen.setOnCheckedChangeListener((group, checkedId) -> {
    ...
    private void initVariables() {
        ...
        radioGroupTen = findViewById(R.id.radioGroup_Question_10);
    }

    private void getDataFromIntent() {
        Bundle bundle = getIntent().getExtras();
        if (bundle != null) {
            scoreHolder.setQuizScore(bundle.getIntegerArrayList("question09Answer"));
    ...
    public void goToQuestionEleven(View view) {
        Log.i(TAG, "goToQuestionEleven: pressed");
        Intent intent = new Intent(this, QuizQuestion11Content.class);
        intent.putExtra("question10Answer", scoreHolder.getQuizScore());
