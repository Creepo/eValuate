...
public class QuizQuestion05Content extends AppCompatActivity {
    private static final String TAG = "QuizQuestion05Content";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_quiz_question_05);
        ...
        radioGroupFive.setOnCheckedChangeListener((group, checkedId) -> {
    ...
    private void initVariables() {
        ...
        radioGroupFive = findViewById(R.id.radioGroup_Question_05);
    }

    private void getDataFromIntent() {
        Bundle bundle = getIntent().getExtras();
        if (bundle != null) {
            scoreHolder.setQuizScore(bundle.getIntegerArrayList("question04Answer"));
    ...
    public void goToQuestionSix(View view) {
        Log.i(TAG, "goToQuestionSix: pressed");
        Intent intent = new Intent(this, QuizQuestion06Content.class);
        intent.putExtra("question05Answer", scoreHolder.getQuizScore());
