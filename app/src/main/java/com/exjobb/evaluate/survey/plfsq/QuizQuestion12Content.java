...
public class QuizQuestion12Content extends AppCompatActivity {
    private static final String TAG = "QuizQuestion12Content";
    ...
    private static TYPE currentTypes = TYPE.GREEN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_quiz_question_12);
    ...
    private void initVariables() {
        ...
        editText = findViewById(R.id.editText_Question_12);
    ...
    private void getDataFromIntent() {
        ...
        if (bundle != null) {
            scoreHolder.setQuizScore(bundle.getIntegerArrayList("question11Answer"));
    ...
    private static Camera.PreviewCallback previewCallback = new Camera.PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            TYPE newType = currentTypes;
            if (imgAvg < rollingAverage) {
                newType = TYPE.RED;
                if (newType != currentTypes) {
                    beats++;
    ...
    public void goToQuestionThirteen(View view) {
        Log.i(TAG, "goToQuestionThirteen: pressed");
        getInput();

        Intent intent = new Intent(this, QuizQuestion13Content.class);
        intent.putExtra("question12Answer", scoreHolder.getQuizScore());
