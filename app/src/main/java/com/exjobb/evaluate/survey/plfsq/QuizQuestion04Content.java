...
public class QuizQuestion04Content extends AppCompatActivity {
    private static final String TAG = "QuizQuestion04Content";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_quiz_question_04);
    ...
    private void initVariables() {
        ...
        radioGroupFour = findViewById(R.id.radioGroup_Question_04);
    }

    private void getDataFromIntent() {
        Bundle bundle = getIntent().getExtras();
        if (bundle != null) {
            scoreHolder.setQuizScore(bundle.getIntegerArrayList("question03Answer"));
    ...
    public void goToQuestionFive(View view) {
        Log.i(TAG, "goToQuestionFive: pressed");
        Intent intent = new Intent(this, QuizQuestion05Content.class);
        intent.putExtra("question04Answer", scoreHolder.getQuizScore());
