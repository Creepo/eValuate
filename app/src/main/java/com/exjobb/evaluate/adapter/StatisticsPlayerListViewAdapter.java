...
public class StatisticsPlayerListViewAdapter extends BaseAdapter {
    private static final String TAG = "StatisticsListViewAdapter";
    private Activity activity;
    private ArrayList<ListItemPlayerModel> list;

    public StatisticsPlayerListViewAdapter(Activity activity, ArrayList<ListItemPlayerModel> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ListItemPlayerModel itemModel = list.get(position);
